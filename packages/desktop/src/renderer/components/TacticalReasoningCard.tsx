...
const THEME_MAP: Record<string, ThemePalette> = {
  red: {
    ...
    subtext: '#b91c1c',
    badgeText: '#991b1b',
    surfaceWhite: 'rgba(255, 255, 255, 0.98)',
    surfaceRaised: 'rgba(255, 255, 255, 0.96)',
    surfaceOverlay: 'rgba(255, 255, 255, 0.94)',
    metricCardBg: 'rgba(255, 255, 255, 0.84)',
    graphActionBg: 'rgba(255, 255, 255, 0.86)',
  },
  emerald: {
    accent: '#059669',
...
const DARK_THEME_MAP: Record<string, ThemePalette> = {
  red: {
    accent: '#ef4444',
    accentSoft: 'rgba(239, 68, 68, 0.16)',
    accentMuted: 'rgba(239, 68, 68, 0.09)',
    border: 'rgba(239, 68, 68, 0.28)',
    panel: 'linear-gradient(180deg, rgba(69, 10, 10, 0.96), rgba(17, 19, 23, 0.98))',
    panelSoft: 'rgba(24, 24, 27, 0.72)',
    graphSurface: 'rgba(23, 15, 15, 0.96)',
    text: '#fecaca',
    subtext: '#fca5a5',
    badgeText: '#fecaca',
    surfaceWhite: 'rgba(24, 24, 27, 0.98)',
    surfaceRaised: 'rgba(24, 24, 27, 0.96)',
    surfaceOverlay: 'rgba(28, 28, 32, 0.94)',
    metricCardBg: 'rgba(28, 28, 32, 0.84)',
    graphActionBg: 'rgba(28, 28, 32, 0.86)',
  },
  emerald: {
    accent: '#10b981',
    ...
    panel: 'linear-gradient(180deg, rgba(6, 46, 33, 0.96), rgba(17, 19, 23, 0.98))',
    panelSoft: 'rgba(24, 24, 27, 0.72)',
    graphSurface: 'rgba(15, 25, 20, 0.96)',
    text: '#a7f3d0',
    subtext: '#6ee7b7',
    badgeText: '#a7f3d0',
    surfaceWhite: 'rgba(24, 24, 27, 0.98)',
  ...
  amber: {
    ...
    accentMuted: 'rgba(245, 158, 11, 0.09)',
    border: 'rgba(245, 158, 11, 0.28)',
    panel: 'linear-gradient(180deg, rgba(52, 38, 8, 0.96), rgba(17, 19, 23, 0.98))',
    panelSoft: 'rgba(24, 24, 27, 0.72)',
    graphSurface: 'rgba(25, 22, 12, 0.96)',
    text: '#fde68a',
    subtext: '#fcd34d',
    badgeText: '#fde68a',
    surfaceWhite: 'rgba(24, 24, 27, 0.98)',
  ...
  blue: {
    ...
    accentMuted: 'rgba(59, 130, 246, 0.09)',
    border: 'rgba(59, 130, 246, 0.28)',
    panel: 'linear-gradient(180deg, rgba(15, 23, 42, 0.96), rgba(17, 19, 23, 0.98))',
    panelSoft: 'rgba(24, 24, 27, 0.72)',
    graphSurface: 'rgba(15, 20, 30, 0.96)',
    text: '#bfdbfe',
    subtext: '#93c5fd',
    badgeText: '#bfdbfe',
    surfaceWhite: 'rgba(24, 24, 27, 0.98)',
...
const GraphViz: React.FC<{
  ...
  useEffect(() => {
    ...
    edgeGroups
      ...
      .attr('height', 20)
      .attr('rx', 10)
      .attr('fill', palette.surfaceRaised)
    ...
    nodeGroups
      ...
      .attr('fill', palette.surfaceWhite)
      .attr('stroke', palette.accent)
      .attr('stroke-width', 2);
...
const TacticalReasoningCard: React.FC<TacticalReasoningCardProps> = ({
  ...
  const palette = theme === 'dark' ? DARK_THEME_MAP.blue : DEFAULT_THEME;
  ...
  const graphActionStyle: React.CSSProperties = {
    borderRadius: 999,
    border: `1px solid ${palette.border}`,
    background: palette.graphActionBg,
    color: palette.badgeText,
    fontSize: 12,
    fontWeight: 700,
    height: 28,
              ...
              {metrics.map((item, index) => (
                <div
                  ...
                  style={{
                    borderRadius: 12,
                    border: `1px solid ${palette.border}`,
                    background: palette.metricCardBg,
                    padding: '12px 14px',
                  }}
                >
                  <div
