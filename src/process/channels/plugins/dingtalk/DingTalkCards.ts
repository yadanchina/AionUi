...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'DataExa Assistant',
    text: '### DataExa Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingHelpCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '',
      '**What is pairing?**',
      'Pairing links your DingTalk account with the local DataExa application.',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'DataExa Assistant Help',
    text: [
      '### DataExa Assistant Help',
      '',
      'A remote assistant to interact with DataExa via DingTalk.',
      '',
      '**Common Actions:**',
